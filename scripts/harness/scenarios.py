...
BROWSER_SCENARIOS: dict[str, BrowserScenario] = {
    ...
    "register_smoke": BrowserScenario(
        name="register_smoke",
        path="/register",
        requires_auth=False,
        required_text="注册",
        notes="Validate the unified operator registration form renders.",
    ),
    "test_auth_smoke": BrowserScenario(
        name="test_auth_smoke",
        path="/test-auth",
        requires_auth=False,
        required_text="认证诊断",
        notes="Open the diagnostic auth page and capture console evidence.",
    ),
    "admin_users_smoke": BrowserScenario(
        name="admin_users_smoke",
        path="/admin/users",
        requires_auth=True,
        required_text="用户管理",
        notes="Open the admin user management console.",
    ),
    "admin_stats_smoke": BrowserScenario(
        name="admin_stats_smoke",
        path="/admin/stats",
        requires_auth=True,
        required_text="统计数据",
        notes="Open the admin statistics console.",
    ),
    "admin_settings_smoke": BrowserScenario(
        name="admin_settings_smoke",
        path="/admin/settings",
        requires_auth=True,
        required_text="系统设置",
        notes="Open the admin settings placeholder in the operator shell.",
    ),
    ...
    "environment_asset_smoke": BrowserScenario(
        name="environment_asset_smoke",
        path="/environments",
        requires_auth=True,
        required_text="环境资产",
        notes="Open the environment asset entrypoint and capture IP-link evidence.",
    ),
    "environment_migration_smoke": BrowserScenario(
        ...
        requires_auth=True,
        required_text="环境资产",
        notes="Legacy alias for the environment asset entrypoint.",
    ),
    "environment_detail_smoke": BrowserScenario(
        ...
        requires_auth=True,
        required_text="环境详情",
        notes="Open the environment detail generation workspace and capture IP-link evidence.",
    ),
    ...
    "episode_script_generation_form_smoke": BrowserScenario(
        ...
        requires_auth=True,
        required_text="重新生成剧本",
        notes="Open the episode script tab and confirm unified script workspace controls render.",
    ),
    "script_detail_smoke": BrowserScenario(
        name="script_detail_smoke",
        path="/scripts/{script_id}",
        requires_auth=True,
        required_text="剧本详情",
        notes="Open the script detail operator workspace.",
    ),
