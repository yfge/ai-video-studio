...
export function TimelineOverview({
  ...
  const containerClass = compact
    ? "border-b border-slate-200 bg-slate-50/70 px-2 py-2"
    : "border-b border-slate-200 bg-slate-50/70 px-3 py-2";
  ...
  const railClass = compact
    ? "relative h-7 overflow-hidden rounded-lg border border-slate-200 bg-white"
    : "relative h-8 overflow-hidden rounded-lg border border-slate-200 bg-white";
    ...
    >
      <div className={gridClass}>
        <div
          ...
          className="whitespace-nowrap text-[11px] font-bold leading-none text-slate-600"
