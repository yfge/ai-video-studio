          ...
          main={
            <OperatorMainCanvas className="space-y-5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      当前生产围绕 IP、故事、剧集和环境资产推进；新内容优先从 IP
                      项目进入。
                    </p>
                  </div>
                  <Link
              ...
              <div className="grid gap-3 md:grid-cols-4">
                <MetricCard
                  label="今日待处理"
                  value={summary.metrics.pending_tasks}
                />
                <MetricCard
                  label="生成中"
                  value={summary.metrics.running_tasks}
                />
                <MetricCard
                  label="失败任务"
                  value={summary.metrics.failed_tasks}
                  tone="red"
                />
                <MetricCard
                  label="可继续生产"
                      ...
                      {summary.recent_episodes.map((episode) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <StatusPill
                              tone={episode.timeline_ready ? "green" : "blue"}
                            >
