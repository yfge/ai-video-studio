...
const AlertModalContext = createContext<AlertContextValue | undefined>(
  undefined,
);
    ...
    case "success":
      return (
        <svg
          ...
          fill="none"
          stroke="currentColor"
          className={`${baseProps.className} text-green-600`}
        >
          <path
            d="M9 12l2 2 4-4"
            strokeLinecap="round"
    ...
    case "error":
      return (
        <svg
          ...
          fill="none"
          stroke="currentColor"
          className={`${baseProps.className} text-red-600`}
        >
          <path
            d="M9 9l6 6m0-6l-6 6"
            strokeLinecap="round"
    ...
    case "warning":
      return (
        <svg
          ...
          fill="none"
          stroke="currentColor"
          className={`${baseProps.className} text-amber-500`}
        >
          <path
            d="M12 8v4m0 4h.01"
            strokeLinecap="round"
    ...
    default:
      return (
        <svg
          ...
          fill="none"
          stroke="currentColor"
          className={`${baseProps.className} text-blue-600`}
        >
          <circle cx="12" cy="12" r="9" />
          <path
