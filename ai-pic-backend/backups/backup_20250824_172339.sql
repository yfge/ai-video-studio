...
INSERT INTO `alembic_version` VALUES ('0002_add_user_management_fields');
...
CREATE TABLE `tasks` (
  ...
  `prompt` text,
  `parameters` text,
  `result_file_path` varchar(256) DEFAULT NULL,
  `error_message` text,
  `user_id` int NOT NULL,
  `created_at` datetime DEFAULT (now()),
...
INSERT INTO `virtual_ips` VALUES (1,'小雅','一个活泼可爱的年轻女孩，充满好奇心和冒险精神','[\"年轻\", \"活泼\", \"女性\", \"现代\"]','小雅是一个22岁的大学生，主修艺术设计。她性格开朗，喜欢探索新事物，经常在社交媒体上分享她的日常生活和创作。她梦想成为一名知名的平面设计师。','年轻亚洲女性，22岁，长黑发，大眼睛，甜美笑容，现代时尚穿着，充满活力',NULL,NULL,1,1,'2025-08-12 07:46:26',NULL),(2,'李教授','一位博学的中年教授，温和而富有智慧','[\"中年\", \"教授\", \"男性\", \"知识分子\"]','李教授是一位45岁的大学教授，专门研究人工智能和机器学习。他为人温和，深受学生喜爱，经常在学术会议上发表演讲。他有一个幸福的家庭，业余时间喜欢阅读和园艺。','中年亚洲男性，45岁，戴眼镜，温和表情，学者气质，正装或休闲装',NULL,NULL,1,1,'2025-08-12 07:46:26',NULL),(3,'奶奶陈','一位慈祥的老奶奶，充满人生智慧','[\"老年\", \"奶奶\", \"女性\", \"慈祥\"]','陈奶奶今年70岁，是一位退休的小学老师。她有三个孙子孙女，非常疼爱他们。她喜欢做饭、织毛衣，经常给邻居的孩子们讲故事。她的人生阅历丰富，总是能给年轻人很好的建议。','亚洲老年女性，70岁，银白头发，慈祥笑容，传统或舒适穿着，温暖气质',NULL,NULL,1,1,'2025-08-12 07:46:26',NULL),(4,'测试IP','测试描述','[\"测试\"]',NULL,NULL,'[]',NULL,1,1,'2025-08-13 17:02:13',NULL),(5,'宝宝','一个美丽的中国女子，全世界都喜欢','[\"大女主\"]','',NULL,'[]',NULL,1,0,'2025-08-13 17:14:34',NULL),(7,'测试角色','这是一个测试角色','[\"测试\", \"角色\"]',NULL,NULL,'[]',NULL,1,0,'2025-08-13 17:16:13',NULL);
...
-- Dump completed on 2025-08-24 17:23:39
