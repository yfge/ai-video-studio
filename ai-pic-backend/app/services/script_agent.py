...
from app.services.script_validation import ScriptValidationSuite
from app.services.validators.character_consistency_validator import CharacterProfile
...
class ScriptLangGraphAgent:
    ...
    def __init__(self, service: "AIService") -> None:
        ...
        self._validation = ScriptValidationSuite(logger=self.logger)
    ...
    def _build_character_profiles(
        ...
        return self._validation.build_character_profiles(characters)

    def _validate_script_characters(
        self,
        content: Dict[str, Any],\n        story_characters: List[Dict[str, Any]],\n        episode_id: Optional[int] = None,\n        db: Optional["Session"] = None
    ) -> Dict[str, Any]:
        return self._validation.validate_script_characters(content, story_characters, episode_id, db)

    def _validate_info_gate(
        self,
        content: Dict[str, Any],\n        episode_number: int,\n        continuity_ledger: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        return self._validation.validate_info_gate(content, episode_number, continuity_ledger)

    def _validate_scene_transitions(
        self,
        content: Dict[str, Any],
    ) -> Dict[str, Any]:
        return self._validation.validate_scene_transitions(content)

    def _validate_script_quality(
        self,
        content: Dict[str, Any],\n        story_characters: List[Dict[str, Any]],
    ) -> Dict[str, Any]:
        return self._validation.validate_script_quality(content, story_characters)
