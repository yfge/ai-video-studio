...
async def test_openai_api(
    ...
    try:
        ...
        return {"success": False, "error": f"OpenAI API测试失败: {str(e)}"}
...
async def test_oss_service(
    ...
    try:
        ...
        return {"success": False, "error": f"OSS服务测试失败: {str(e)}"}
...
async def test_oss_image_upload(
    ...
    try:
        ...
        return {"success": False, "error": f"OSS图片上传测试失败: {str(e)}"}
...
async def test_database_connection(
    ...
    try:
        ...
        return {"success": False, "error": f"数据库测试失败: {str(e)}"}
...
async def test_file_system(
    ...
    try:
        ...
        return {"success": False, "error": f"文件系统测试失败: {str(e)}"}
...
async def test_end_to_end_generation(
    ...
    try:
        ...
        return {"success": False, "error": f"端到端测试失败: {str(e)}"}
