...
class TestVirtualIPAPI:
    ...
    def test_generate_virtual_ip_image(
        self, client: TestClient, db_session: Session, mock_ai_service
    ):
        """测试生成虚拟IP图像"""
        setup_factories(db_session)
    ...
    def test_generate_virtual_ip_image_variant(
        ...
        class _DummyAIManager:
            def __init__(self) -> None:
                ...
                self.last_prefer_provider: str | None = None
            ...
            async def image_to_image(
                ...
                **_: str,
                ...
                self.last_prefer_provider = prefer_provider
                return _DummyResp()
            ...
            async def _persist_generated_image(
                ...
                *,
                ...
                return {
                    ...
                    "filename": filename,
                    "oss_url": (
                        "https://oss.example.com/ai-generated/virtual-ip/image/variant_test.png"
                        if require_upload
                        else None
                    ),
                    "oss_upload": (
        ...
        assert dummy_service.ai_manager.last_prefer_provider == "google"
        assert dummy_service.ai_manager.last_model == "gemini-3-pro-image-preview"
...
class TestAPIValidation:
    ...
    def test_create_virtual_ip_validation(
...
class TestEndToEndWorkflow:
    ...
    def test_complete_story_creation_workflow(
        ...
        create_episode_response = client.post(
            "/api/v1/episodes/", json=create_episode_data
        )
